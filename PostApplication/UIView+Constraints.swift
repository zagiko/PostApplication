...
//  PostApplication
//
//  Created by Mykhailo Zagiko on 06.09.2023.
//
...
extension UIView {
    ...
    func alignLeadingGreaterThanOrEqual(to anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0.0) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func alignTrailingWithConstraint(to anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0.0) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let constraint = trailingAnchor.constraint(equalTo: anchor, constant: -constant)
        constraint.isActive = true
        return constraint
    ...
    func alignCenterXWithConstraint(to view: UIView, constant: CGFloat = 0.0) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let constraint = centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: constant)
        constraint.isActive = true
        return constraint
    ...
    func setHeightGreaterThanOrEqualTo(constant: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func setWidthGreatConstantWithConstraint(constant: CGFloat) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let width = widthAnchor.constraint(greaterThanOrEqualToConstant: constant)
        width.isActive = true
        return width
    }
    ...
    func equalWidth(to view: UIView, constant: CGFloat = 0.0) {
        translatesAutoresizingMaskIntoConstraints = false
        self.widthAnchor.constraint(
